...
class GlucoseCircleView @JvmOverloads constructor(
    ...
    fun setGlucose(
        ...
        val newColor = when (range) {
            ...
            GlucoseRange.LOW -> ContextCompat.getColor(context, R.color.high)
            GlucoseRange.IN_RANGE -> ContextCompat.getColor(context, R.color.inRange)
            GlucoseRange.HIGH -> ContextCompat.getColor(context, R.color.glucose_ring_step3)
